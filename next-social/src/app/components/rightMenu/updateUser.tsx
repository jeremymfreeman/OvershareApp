                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
                            ...
                            <div className="flex flex-col gap-4 lg:w-1/3 xl:w-1/3">
                                ...
                                <input type="text" name="description" placeholder={user.description || "Tell people about yourself..."} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"/>
                            </div>
                            {/* INPUT */}
                            <div className="flex flex-col gap-4 lg:w-1/3 xl:w-1/3">
                                <label htmlFor="" className="text-xs text-gray-500">
                                ...
                                <input type="text" name="city" placeholder={user.city || "Los Angeles"} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"/>
                            </div>
                            {/* INPUT */}
                            <div className="flex flex-col gap-4 lg:w-1/3 xl:w-1/3">
                                <label htmlFor="" className="text-xs text-gray-500">
                                ...
                                <input type="text" name="school" placeholder={user.school || "UCLA"} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"/>
                            </div>
                            {/* INPUT */}
                            <div className="flex flex-col gap-4 lg:w-1/3 xl:w-1/3">
                                <label htmlFor="" className="text-xs text-gray-500">
                                ...
                                <input type="text" name="work" placeholder={user.work || "Microsoft"} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"/>
                            </div>
                            {/* INPUT */}
                            <div className="flex flex-col gap-4 lg:w-1/3 xl:w-1/3">
                                <label htmlFor="" className="text-xs text-gray-500">
                                ...
                                <input type="text" name="website" placeholder={user.website || "google.com"} className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"/>
                            </div>
                        </div>
                        <UpdateButton/>
